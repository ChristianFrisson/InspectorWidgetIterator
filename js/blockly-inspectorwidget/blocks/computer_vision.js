    ...
    updateShape_: function(test) {
        ...
        if (test === 'IF'){
            ...
            this.appendDummyInput('TEST_VALUE')
                ...
                .appendField(new Blockly.FieldTemplate('template1'), 'TEMPLATE1')
                .appendField(new Blockly.FieldLabel(','))
                .appendField(new Blockly.FieldTemplate('template2'), 'TEMPLATE2')
                .appendField(new Blockly.FieldLabel(')'));
            ...
            this.appendDummyInput('TEST_VALUE')
                .appendField(new Blockly.FieldLabel('('))
                .appendField(new Blockly.FieldTemplate('template'), 'TEMPLATE')
                .appendField(new Blockly.FieldLabel(')'));
        }
        else if (test === 'INRECT'){
            /*if (testValueInputExists) {
