...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '  background: url(<<<PATH>>>/sprites.png) no-repeat -48px -12px !important;',
  '}',
  ...
  '  height: 10px;',/*InspectorWidget*/
  '  vertical-align: middle;',
  '  width: 10px;',/*InspectorWidget*/
  '}',
  ...
  '.blocklyTreeIconOpen {',
  '  background-position: -12px -1px;',/*InspectorWidget*/
  '}',
  ...
  '  cursor: default;',
  '  font-family: sans-serif;',
  '  font-size: 12px;',/*InspectorWidget*/
  '  padding: 0 3px;',
  '  vertical-align: middle;',
  '}',
